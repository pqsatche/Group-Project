                                ...
                                echo '        <br>
                                                ...
                                                <form name="basic" method="POST" action="reports.php">
                                                        <table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
                                                                ...
                                                                <tr><td></td><input type="hidden" name="id" value=' . $row[0] . '" size"10"></td></tr>
                                                                <tr><td>Report Name: </td><td><input type="edit" name="reportname" value="' . $row[1] . '" size="30"></td></tr>
                                                                <tr><td>Report Query: </td><td><input type="edit" name="reportquery" value="' . $row[2] . '" size="20"></td></tr>
                                                                <tr><td>Person: </td><td><input type="edit" name="persons_id" value="' . $row[3] . '" size="30"></td></tr>
                                                                <tr><td>Date Created: </td><td><input type="edit" name="date_created" value="' . $row[4] . '" size="20"></td></tr>';
